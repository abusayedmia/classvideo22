 ...
 <html lang="en">
   <head>
     ...
     <title>Class 22 Full website</title>
   </head>
   <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light rakib-header">
      <div class="container">
        ...
        <a class="navbar-brand" href="#"><span><i class="fa fa-mobile"></i></span> AppAMP Theme</a>
        ...
        <div class="collapse navbar-collapse ml-5 justify-content-between" id="navbarSupportedContent">
          <ul class="navbar-nav rakib-menu ml-5 mb-2 mb-lg-0">
            <li class="nav-item">
    ...
    <div class="banner-section">
        <div class="container">
            <div class="row">
                <div class="col">
                    <div class="banner-caption w-50 mx-auto text-white text-center">
                        ...
                        <form action="#">
                            <div class="row">
                                ...
                                <div class="col-lg-5">
                                    <button type="submit" class=" banner-btn1">Get App</button>
                                </div>
                            </div>
                        </form>
                    </div>
    ...
    <div class="about-section py-5">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4">
                    <img class="rounded" src="https://i.ibb.co/Gtjv2p5/015.jpg" alt="015" border="0">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="feature-section py-5">
        <div class="container">
            <div class="row">
                <div class="row">
                    <div class="col">
                        <div class="feature-text text-center my-5">
                            <h1 class="mb-4">Learn more about our application</h1>
                ...
                <div class="col-lg-4 mb-4">
                    <div class="feature-item d-flex align-items-center">
                        <div class="left-img-sec h-100">
                            <img src="https://mobirise.com/extensions/appamp/assets/images/022.jpg" alt="">
                        </div>
                ...
                <div class="col-lg-4 mb-4">
                    <div class="feature-item d-flex align-items-center">
                        <div class="left-img-sec h-100">
                            <img src=https://mobirise.com/extensions/appamp/assets/images/mbr-7.jpg alt="">
                        </div>
                        <div class="left-text-sec">
                            <h5>MOVE MINUTES</h5>
                ...
                <div class="col-lg-4 mb-4">
                    <div class="feature-item d-flex align-items-center">
                        <div class="left-img-sec h-100">
                            <img src=https://mobirise.com/extensions/appamp/assets/images/mbr-8.jpg alt="">
                        </div>
                        <div class="left-text-sec">
                ...
                <div class="col-lg-4 mb-4">
                    <div class="feature-item d-flex align-items-center">
                        <div class="left-img-sec h-100">
                            <img src=https://mobirise.com/extensions/appamp/assets/images/mbr-5.jpg alt="">
                        </div>
                        <div class="left-text-sec">
                ...
                <div class="col-lg-4 mb-4">
                    <div class="feature-item d-flex align-items-center">
                        <div class="left-img-sec h-100">
                            <img src=https://mobirise.com/extensions/appamp/assets/images/mbr-12.jpg alt="">
                        </div>
                        <div class="left-text-sec">
                            <h5>WORKOUTS</h5>
                ...
                <div class="col-lg-4 mb-4">
                    <div class="feature-item d-flex align-items-center">
                        <div class="left-img-sec h-100">
                            <img src=https://mobirise.com/extensions/appamp/assets/images/mbr-13.jpg alt="">
                        </div>
                        <div class="left-text-sec">
                            <h5>MOTIVATION </h5>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 mb-4">
                    <div class="portfolio-item">
                        <a href="#">
                            <img src=https://mobirise.com/extensions/appamp/assets/images/033.jpg alt="">
                        </a>
                    </div>
                </div>
                ...
                <div class="col-lg-4 mb-4">
                    <div class="portfolio-item">
                        <a href="#">
                            <img src=https://mobirise.com/extensions/appamp/assets/images/background18.jpg alt="">
                        </a>
                    </div>
                </div>
    ...
    <div class="pricing-table-section my-5">
        <div class="container">
            <div class="row mb-5">
            ...
            <div class="row mt-5">
                ...
                <div class="col-lg-6">
                    <div class="pricing-item">
                        ...
                        <h5 class="text-muted mb-4">For simple users</h5>

                        <ul>
                            <li><span><i class="fa-solid fa-check"></i></span> HEART POINTS</li>
                            <li><span><i class="fa-solid fa-check"></i></span> MOVE MINUTES</li>
                            <li><span><i class="fa-solid fa-xmark"></i></span>FITNESS ASSESSMENT</li>
                            <li><span><i class="fa-solid fa-xmark"></i></span> NUTRITIONAL SUCCESS</li>
                        </ul>
    ...
    <div class="testimonial-section py-5">
        <div class="container">
            <div class="row">
                <div class="col text-center">
                    <div class="testimonial-details w-75 mx-auto">
                        <h5 class="text-muted mb-4">Feedback from our users</h5>
                        <h1 class="mb-4">What do users say about our application</h1>
                        <span><i class="fa-solid fa-quote-left"></i></span>
                        <p class="lead">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Debitis perspiciatis vero accusantium excepturi aperiam eius sit quis nobis</p>
    
                        <div class="author-info mt-5">
                            <img class="float-left rounded-circle" src="https://mobirise.com/extensions/appamp/assets/images/face1.jpg" alt="">
                        </div>
    ...
    <div class="team-section py-5">
        <div class="container">
            <h1 class="py-5">Our Team and History</h1>
            <div class="row">
                <div class="col-lg-6">
                        ...
                        <div class="card text-center border-0">
                            <div class="card-body">
                                ...
                                <form action="#">
                                    ...
                                    <textarea name="" class="form-control form-control-lg mb-3" placeholder="Message"></textarea>
    ...
    <div class="container-fluid">
        <div class="get-section">
            <div class="container">
                <div class="row">
                    <div class="col">
                      <div class="get-text w-50 mx-auto text-center mt-5">
                        <p>It is created to watch your health</p>
                        <h1>Get our app for Android and iPhone</h1>
                      </div>
                    </div>
                </div>
                <div class="row my-4">
                    ...
                    ></div>
                    <div class="col-lg-2">
                        <a class="btn btn-info d-block" href="#"><i class="fa-brands fa-apple"></i>App Store</a>
                    </div>
                    <div class="col-lg-2">
                        <a class="btn btn-info d-block" href="#"><i class="fa-solid fa-robot"></i>Google play</a>
                    </div>
